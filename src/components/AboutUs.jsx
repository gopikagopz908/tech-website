...
<div className="flex items-center justify-between w-full px-4 sm:px-6 md:px-8 lg:px-16">  <img

            src="/log.png"
            alt="Logo"
            width={140}
            height={50}
  className="object-contain w-auto max-w-[100px] sm:max-w-[140px] block mx-auto ml-16"
         />
