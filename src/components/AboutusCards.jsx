...
const AboutusCards = () => {
  return (
    <div className="relative w-full overflow-hidden text-white">
      ...
      {/* Content */}
      <div className="relative px-4 sm:px-6 md:px-16 py-16 flex flex-col gap-20">
...
>
  Mentric Technologies
            ...
            {/* Stats */}
            <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-12 sm:mt-24">
              <CountCard value="50+" label="Trusted Clients" />
              <CountCard value="30+" label=" Solutions Delivered" />
              <CountCard value="10k+" label="Active Users" />
            </div>
